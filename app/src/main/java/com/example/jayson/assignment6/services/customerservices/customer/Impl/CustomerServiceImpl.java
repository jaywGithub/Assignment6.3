...
import com.example.jayson.assignment6.repository.customerrepository.CustomerRepository;
import com.example.jayson.assignment6.repository.customerrepository.Impl.CustomerRepositoryImpl;
...
public class CustomerServiceImpl extends IntentService implements CustomerService {
    ...
    public String activateAccount(String name, String surname, String contactNumber) {
        if (true) {
            Customer settings = CustomerFactory.getCustomer(name, surname, contactNumber, customerAddress);
