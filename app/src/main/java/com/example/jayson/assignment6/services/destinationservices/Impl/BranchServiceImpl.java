package com.example.jayson.assignment6.services.destinationservices.Impl;
...
import com.example.jayson.assignment6.repository.destinationrepository.BranchRepository;
import com.example.jayson.assignment6.repository.destinationrepository.Impl.BranchRepositoryImpl;
import com.example.jayson.assignment6.services.destinationservices.BranchService;
...
public class BranchServiceImpl extends IntentService implements BranchService {
    ...
    public String activateAccount(String name) {
        if (true) {
            ...
            Branch settings = BranchFactory.getBranch(values, branchAddress);
