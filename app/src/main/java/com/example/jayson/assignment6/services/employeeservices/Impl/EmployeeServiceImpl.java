package com.example.jayson.assignment6.services.employeeservices.Impl;
...
import com.example.jayson.assignment6.services.employeeservices.EmployeeService;
...
public class EmployeeServiceImpl extends IntentService implements EmployeeService {
    ...
    @Override
    public String activateAccount(String name, String surname, String license) {

        if (true) {
            Employee settings = EmployeeFactory.getEmployee(name, surname, license);
